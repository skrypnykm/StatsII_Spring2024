...
\textit{Both intercepts \underline{are} statistically differentiable from zero at the $\alpha$-level = 0.05.  }
	\item \textbf{REG(negative), 3.972}: On average and holding all the other predictors constant, a shift from being a non-democratic to a democratic country is associated with an increase by a multiplicative factor of 3.972 in the odds of going from having no change in GDP difference to a negative GDP difference.  \textit{The coefficient is \underline{not} statistically differentiable from zero at the $\alpha$-level = 0.05.}
	\item \textbf{REG(positive), 5.865}: On average and holding all the other predictors constant, a shift from being a non-democratic to a democratic country is associated with an increase by a multiplicative factor of 5.865 in the odds of going from having no change in GDP difference to a positive GDP difference. \textit{The coefficient\underline{ is} statistically differentiable from zero at the $\alpha$-level = 0.05.}
...
\textit{Both coefficients for \texttt{OIL} are \underline{not} statistically differentiable from zero at the $\alpha$-level = 0.05.}
	\end{itemize}
...
\end{itemize}
	...
	Just in terms of conducting basic exploratory data analysis, to get an overall idea of the visits frequency, let's calculate the mean number of visits of the winning PAN presidential candidate:
		...
		\lstinputlisting[language=R, firstline=104, lastline=104]{PS3MS.R} 
...
\lstinputlisting[language=R, firstline=107, lastline=109]{PS3MS.R} 
